...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request payload for updating a construction Work Package")
public class UpdateWorkPackageRequest {

    @Schema(description = "Optional Site ID", example = "1")
    private Long siteId;
    ...
    @Schema(description = "Discipline: CIVIL, STRUCTURAL, MEP, ELECTRICAL, PLUMBING, HVAC, FINISHING, FIRE_FIGHTING", example = "CIVIL")
