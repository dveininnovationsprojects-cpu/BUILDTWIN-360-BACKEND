...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request payload for creating a site under a project")
public class CreateSiteRequest {
    ...
    @Schema(description = "Site type (e.g., BUILDING_TOWER, INFRASTRUCTURE, CLUBHOUSE, VILLA_ZONE)", example = "BUILDING_TOWER")
    private String siteType;

    @Schema(description = "Site location or zone description", example = "North Zone, Ashok Grandeur Campus, Padur")
