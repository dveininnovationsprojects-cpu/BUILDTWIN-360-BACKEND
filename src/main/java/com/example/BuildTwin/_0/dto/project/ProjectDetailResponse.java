...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Detailed project master representation including sites and team allocation")
public class ProjectDetailResponse {
    ...
    @Schema(description = "List of physical sites / towers / zones in this project")
    @Builder.Default
    private List<SiteResponse> sites = new ArrayList<>();

    @Schema(description = "List of assigned team members with their project-specific roles")
    @Builder.Default
    private List<ProjectRoleResponse> teamMembers = new ArrayList<>();
